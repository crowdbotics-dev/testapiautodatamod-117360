...
## Project Structure
    ...
    ├── testapiautodatamod_117360  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_117360`
...
2. Clone this repo and `cd testapiautodatamod_117360`
